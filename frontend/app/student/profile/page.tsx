...
const ProfilePage: FC = () => {
  ...
  return (
    <Protected>
      <Heading title={`Profile - ${user?.name}`} description="Student profile" keywords="profile" />
        ...
        <div className="flex-1 flex flex-col w-full 800px:w-4/5">
          ...
          <main className="p-4 sm:p-8 flex-1 overflow-y-auto">
            <div className="max-w-[800px] mx-auto bg-white dark:bg-slate-900 border border-gray-200 dark:border-[#ffffff1d] rounded-2xl shadow-sm p-8">
              <h2 className="text-[24px] font-Poppins font-semibold text-black dark:text-white mb-6 text-center">Manage Profile</h2>
