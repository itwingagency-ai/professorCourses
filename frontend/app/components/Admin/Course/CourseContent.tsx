...
type Props = {
    active: number; // Currently active step in a multi-step process
    setActive: (active: number) => void; // Function to set the active step
    courseContentData: any; // Data array representing the course content
    setCourseContentData: (courseContentData: any) => void; // Function to update course content data
    handleSubmit: any; // Submit handler function for form data
};

// Functional Component to handle course content
        ...
        <div className=" w-[80%] m-auto mt-24 p-3 ">
            ...
            <form onSubmit={handleSubmit}>
                                                ...
                                                <div className=" flex w-full items-center">
                                                    <input
                                                        ...
                                                        onChange={(e) => {
                                                            ...
                                                            updatedData[index] = { ...updatedData[index], videoSection: e.target.value }; // Update the specific field
                                                            setCourseContentData(updatedData);
                                                        }}
                                                    />
                                        ...
                                        <>
                                            ...
                                            <div className="my-3">
                                                ...
                                                <input
                                                    ...
                                                    value={item.title || ''} // Ensure `item.title` has a default empty string fallback
                                                    onChange={(e) => {
                                                        const updatedData = [...courseContentData]; // Create a shallow copy of the array
                                                        updatedData[index] = { ...updatedData[index], title: e.target.value }; // Update the specific field
                                                        setCourseContentData(updatedData); // Update state with the modified array
                                                    }}
                                                />
                                            </div>
                                            ...
                                            <div className="my-3">
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        ...
                                                        updatedData[index] = { ...updatedData[index], videoUrl: e.target.value }; // Update the specific field
                                            ...
                                            <div className="my-3">
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        ...
                                                        const updatedData = [...courseContentData];
                                                        // updateData[index].videoUrl = e.target.value;
                                                        updatedData[index] = { ...updatedData[index], videoLength: e.target.value }; // Update the specific field
                                                        setCourseContentData(updatedData);
                                                    }}
                                                />
                                            </div>
                                            ...
                                            <div className="my-3 flex items-center space-x-2">
                                                <input
                                                    ...
                                                    onChange={(e: any) => {
                                                        const updatedData = [...courseContentData];
                                                        updatedData[index] = { ...updatedData[index], isFreePreview: e.target.checked };
                                                        setCourseContentData(updatedData);
                                                    }}
                                            ...
                                            <div className="my-3">
                                                ...
                                                <textarea
                                                    ...
                                                    onChange={(e) => {
                                                        ...
                                                        updatedData[index] = { ...updatedData[index], description: e.target.value }; // Update the specific field
                                                ...
                                                <div className="mb-3 block" key={linkindex}>
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => {
                                                            ...
                                                            //updatedData[index].links[linkindex] = { ...updatedData[index].links[linkindex], title: e.target.value }; // Update the specific field
                                                            setCourseContentData(updatedData);
                                                        }}
                                                    />
                                                    <input
                                                        ...
                                                        onChange={(e) => {
                                                            ...
                                                            //updatedData[index] = { ...updatedData[index], url: e.target.value }; // Update the specific field
                                                            setCourseContentData(updatedData);
                                                        }}
                                                    />
                                                </div>
                ...
                <div className="flex items-center text-[20px] mt-5 dark:text-white  text-black cursor-pointer"
                    ...
                    <AiOutlinePlusCircle className=" 5 mr-2" /> Add New Section
                </div>
            </form>
