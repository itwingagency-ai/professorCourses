...
const TeacherCourseInformation: FC<Props> = ({ courseInfo, setCourseInfo, active, setActive }) => {
            ...
            <form onSubmit={handleSubmit} className={`${styles.label} space-y-6`}>
                ...
                <div>
                    ...
                    <input
                        ...
                        className={`${styles.input} border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-[#37a39a] focus:border-transparent`}
                    />
                </div>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        className={`${styles.input} !h-min !py-3 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-[#37a39a] focus:border-transparent`}
                ...
                <div className="w-full flex justify-between">
                    ...
                    <div className="w-[45%]">
                        ...
                        <select
                            ...
                            className={`${styles.input} dark:bg-gray-800 bg-transparent border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-[#37a39a] focus:border-transparent`}
                        >
                ...
                <div className="flex items-center mt-4">
                    <input
                        ...
                        checked={courseInfo.isCertificateEnabled ?? true}
                        onChange={(e) => setCourseInfo({ ...courseInfo, isCertificateEnabled: e.target.checked })}
                        className="w-5 h-5 text-[#37a39a] bg-gray-100 border-gray-300 rounded focus:ring-[#37a39a] dark:focus:ring-[#37a39a] dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                    />
                    <label htmlFor="isCertificateEnabled" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                        Enable Auto-Certificate upon 100% completion
                    </label>
                </div>
...
export default TeacherCourseInformation;