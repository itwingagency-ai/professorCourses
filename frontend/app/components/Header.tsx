    ...
    return (
        <div className='w-full relative'>
            <div className={`${active
                ? "glass fixed top-0 left-0 w-full h-[80px] z-[80] shadow-xl transition-all duration-500 bg-white/70 dark:bg-darkBg/70 border-b border-gray-200/50 dark:border-white/10"
                : "w-full border-b border-gray-200/50 dark:border-white/10 h-[80px] z-[80] bg-transparent transition-all duration-500"}`}>
                        ...
                        >
                            <div className="w-[70%] fixed z-[999999999] h-screen bg-white dark:bg-slate-900 dark:bg-opacity-90 top-0 right-0">
                                ...
                                <p className="text-[16px] px-2 pl-5 text-black dark:text-white ">
                                    Copyright © 2023 3S Consultant | All Rights Reserved
                                </p>
                            </div>
                        </div>
